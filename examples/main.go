...
func poolDemo() {
	...
	dst, err = helper.ZipLevel(data, libdeflate.MaxCompressionLevel)
	fmt.Println("zip err:", err)      // zip err: <nil>
	fmt.Println("zip len:", len(dst)) // zip len: 43
